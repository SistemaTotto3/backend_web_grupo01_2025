...
import  {obtenerInsumos, obtenerInsumo, registrarInsumo, eliminarInsumo,  actualizarInsumoPatch}  from '../controllers/insumo.controller.js';
const router = Router();
...
router.patch('/actualizarInsumoPatch/:id_insumo', actualizarInsumoPatch);
